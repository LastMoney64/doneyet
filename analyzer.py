...
⚠️ 중요: 오늘 날짜는 {current_year}년입니다. 연도가 명시되지 않은 모든 날짜는 반드시 {current_year}년으로 처리하세요. 절대로 과거 연도(2025년 이하)를 사용하지 마세요.
...
{{
  ...
  "deadline": "마감일시 (YYYY-MM-DD HH:MM 형식, 없으면 null, 연도 없으면 반드시 {current_year}년 사용)",
